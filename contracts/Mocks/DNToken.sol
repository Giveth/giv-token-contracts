...
contract Token is IERC20 {
    ...
    modifier onlyMinter {
        require(msg.sender == minter, "DN::onlyMinter: NOT_MINTER");
        _;
    }
    ...
    function _validateSignedData(
        ...
        require(
            ...
            "DN::_validateSignedData: INVALID_SIGNATURE"
        );
    }
    ...
    function _transfer(
        ...
        require(
            ...
            "DN::_transfer: NOT_VALID_TRANSFER"
        );
        // Balance is implicitly checked with SafeMath's underflow protection
        balanceOf[from] = balanceOf[from] - value;
        balanceOf[to] = balanceOf[to] + value;
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "DN::permit: AUTH_EXPIRED");
        bytes32 encodeData =
            keccak256(
                abi.encode(
                    PERMIT_TYPEHASH,
    ...
    function transferWithAuthorization(
        ...
        require(
            ...
            "DN::transferWithAuthorization: AUTH_NOT_YET_VALID"
        );
        require(
            block.timestamp < validBefore,
            "DN::transferWithAuthorization: AUTH_EXPIRED"
        );
        require(
            !authorizationState[from][nonce],
            "DN::transferWithAuthorization: AUTH_ALREADY_USED"
        );
