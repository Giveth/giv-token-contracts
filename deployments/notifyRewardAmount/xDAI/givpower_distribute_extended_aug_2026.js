...
const distro = [
    // https://github.com/Giveth/giveth-dapps-v2/issues/5620
    833, 833, 833, 833, 833, 833, 833, 833, 834, 834, 834, 834,
];

const initTime = 1787072400; // Timestamp of first round in seconds: Tuesday, AUG 18, 2026 17:00:00 GMT
...
async function notifyRewardAmount(pool) {
    ...
    if (periodFinish < currentTime + 60 * 10) {
        ...
        await sendReportEmail({
            ...
            pool: pool.address,
            round: pos + 1,
            script: "givpower_distribute_extended_aug_2026.js",
