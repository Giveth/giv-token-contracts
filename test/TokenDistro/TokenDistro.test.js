...
describe("TokenDistro", function() {
    ...
    it("should deploy the TokenDistro", async () => {
        ...
        expect(await TokenDistro.globallyClaimableAt(startTime + offset)).to.be.equal(
            initialAmount,
        );
        // t + 1 = startToCliff
    ...
    it("should be able to get the correct claimableAt", async () => {
        ...
        // startTime > t
        expect(
            await TokenDistro.claimableAt(recipientAddress1, startTime - offset / 2),
        ).to.be.equal(0);
        // startTime = t
        ...
        expect(
            await TokenDistro.claimableAt(recipientAddress1, startTime + _startToCliff),
        ...
        // t = startToEnd
        expect(
            await TokenDistro.claimableAt(recipientAddress1, startTime + startToEnd),
    ...
    it("should be able to withdraw", async () => {
        ...
        const amountGrantedRecipient1 = (await TokenDistro.balances(recipientAddress1))
            .allocatedTokens;
