/* eslint-disable no-return-await,new-cap */
...
import { IUniswapV3Pool, TestERC20 } from "../../../typechain-types";
...
export const erc20Wrap = async (x: string | TestERC20): Promise<TestERC20> => {
    if (isString(x)) {
        ...
        return factory.attach(x as string) as TestERC20;
    }
    return x as TestERC20;
};
