...
import { TestRewardMath } from "../../../../typechain-types";
...
describe("unit/RewardMath", () => {
    ...
    it("half the liquidity over 20% of the total duration", async () => {
        const { reward, secondsInsideX128 } =
            await rewardMath.computeRewardAmount(
                ...
                /* secondsPerLiquidityInsideX128= */ BigNumber.from(20)
                    .shl(128)
                    .div(10),
                /* currentTime= */ 120,
            );
    ...
    it("all the liquidity for the duration and none of the liquidity after the end time for a whole duration", async () => {
        const { reward, secondsInsideX128 } =
            await rewardMath.computeRewardAmount(
                ...
                /* liquidity= */ 100,
                /* secondsPerLiquidityInsideInitialX128= */ 0,
                /* secondsPerLiquidityInsideX128= */ BigNumber.from(100)
                    .shl(128)
                    .div(100),
                /* currentTime= */ 300,
            );
